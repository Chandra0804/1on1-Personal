  ...
  return (
    <div className='pricing-section'>
      ...
      <div className='pricing-cards'>
        <div className='card1'>
            <p className='payment-amount'><span className='big-amount-text' >1,50,000</span>/ Full Payment</p>
        ...
        <div className='card2'>
            <p className='payment-amount'><span className='big-amount-text' >50,000</span> / 3 months</p>
        ...
        <div className='card3'>
            <p className='payment-amount'><span className='big-amount-text'>25,000</span> / 7 months</p>
